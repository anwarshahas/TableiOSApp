...
- (void)setBottomBorderColour:(UIColor *)borderColour andBorderWidth:(CGFloat)borderWidth {
    CALayer *BottomBorder = [CALayer layer];
    BottomBorder.frame = CGRectMake(0.0f, self.frame.size.height-1, self.frame.size.width, borderWidth);
    BottomBorder.backgroundColor = borderColour.CGColor;
